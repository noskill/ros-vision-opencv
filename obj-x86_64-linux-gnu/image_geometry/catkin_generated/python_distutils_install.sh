...
echo_and_run cd "/root/ros-vision-opencv-1.13.0+ds/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/ros-vision-opencv-1.13.0+ds/image_geometry/setup.py" \
    build --build-base "/root/ros-vision-opencv-1.13.0+ds/obj-x86_64-linux-gnu/image_geometry" \
    install \
    $DESTDIR_ARG \
