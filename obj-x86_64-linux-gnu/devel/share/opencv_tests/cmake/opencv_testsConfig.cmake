...
set(opencv_tests_SOURCE_PREFIX /root/ros-vision-opencv-1.13.0+ds/opencv_tests)
set(opencv_tests_DEVEL_PREFIX /root/ros-vision-opencv-1.13.0+ds/obj-x86_64-linux-gnu/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros-vision-opencv-1.13.0+ds/opencv_tests/${idir}'.  ${_report}")
    endif()
