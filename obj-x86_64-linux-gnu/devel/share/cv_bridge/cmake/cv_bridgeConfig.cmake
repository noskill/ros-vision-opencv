...
set(cv_bridge_SOURCE_PREFIX /root/ros-vision-opencv-1.13.0+ds/cv_bridge)
set(cv_bridge_DEVEL_PREFIX /root/ros-vision-opencv-1.13.0+ds/obj-x86_64-linux-gnu/devel)
...
if(NOT "/root/ros-vision-opencv-1.13.0+ds/cv_bridge/include;/usr/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/root/ros-vision-opencv-1.13.0+ds/cv_bridge/include;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros-vision-opencv-1.13.0+ds/cv_bridge/${idir}'.  ${_report}")
    endif()
