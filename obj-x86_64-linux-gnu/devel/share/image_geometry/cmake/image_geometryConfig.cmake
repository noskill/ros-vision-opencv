...
set(image_geometry_SOURCE_PREFIX /root/ros-vision-opencv-1.13.0+ds/image_geometry)
set(image_geometry_DEVEL_PREFIX /root/ros-vision-opencv-1.13.0+ds/obj-x86_64-linux-gnu/devel)
...
if(NOT "/root/ros-vision-opencv-1.13.0+ds/image_geometry/include;/usr/include/opencv4 " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/root/ros-vision-opencv-1.13.0+ds/image_geometry/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros-vision-opencv-1.13.0+ds/image_geometry/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ros-vision-opencv-1.13.0+ds/obj-x86_64-linux-gnu/devel/lib)
